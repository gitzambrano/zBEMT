...
class _TestWindow(unittest.TestCase):
    ...
    teardown defect that prevents `tests/regression/test_airfoil_tab.py` from running
    here.
    """
    ...
    def tearDownClass(cls):
        ...
        # end of the suite on this machine. (Update: `tests/regression/test_airfoil_tab.py`
