...
tests/regression/test_gui_smoke.py). ``QT_QPA_PLATFORM=offscreen`` is already set by
tests/conftest.py.

Hard rule of this file (has bitten this repo before -- see
tests/regression/test_gui_smoke.py): NEVER let a real ``QMessageBox`` appear under
