...
T7 (production-plan.md): `tests/regression/test_cli_parity.py` only compares the CLI
...
(A) via the GUI's real widgets (same pattern as tests/regression/test_gui_smoke.py:
